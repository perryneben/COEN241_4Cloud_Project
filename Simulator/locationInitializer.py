...
a7.setNeighbor(a6, 6)
a7.setNeighbor(b7, 9)
a7.setNeighbor(a8, 11)

a8.setNeighbor(a7, 11)
a8.setNeighbor(b8, 1)

# Set the neighbors for the B nodes
b0.setNeighbor(a0, 5)
b0.setNeighbor(c0, 15)
b0.setNeighbor(b1, 10)

b1.setNeighbor(b0, 10)
b1.setNeighbor(a1, 9)
b1.setNeighbor(b2, 4)
b1.setNeighbor(c1, 9)
...
b7.setNeighbor(b6, 6)
b7.setNeighbor(a7, 9)
b7.setNeighbor(c7, 12)
b7.setNeighbor(b8, 10)

b8.setNeighbor(a8, 1)
b8.setNeighbor(b7, 10)
b8.setNeighbor(c8, 11)

# Set the neighbors for the C nodes
c0.setNeighbor(b0, 15)
c0.setNeighbor(d0, 4)
c0.setNeighbor(c1, 5)
...
c5.setNeighbor(b5, 3)
c5.setNeighbor(d5, 5)
c5.setNeighbor(c6, 11)

c6.setNeighbor(c5, 11)
c6.setNeighbor(b6, 6)
c6.setNeighbor(d6, 2)
c6.setNeighbor(c7, 9)

c7.setNeighbor(c6, 9)
c7.setNeighbor(b7, 12)
c7.setNeighbor(d7, 7)
c7.setNeighbor(c8, 4)

c8.setNeighbor(c7, 4)
c8.setNeighbor(b8, 11)
c8.setNeighbor(d8, 9)
...
d3.setNeighbor(d2, 7)
d3.setNeighbor(c3, 8)
d3.setNeighbor(e3, 10)
d3.setNeighbor(d4, 10)

d4.setNeighbor(d3, 10)
d4.setNeighbor(c4, 5)
d4.setNeighbor(e4, 4)
d4.setNeighbor(d5, 8)
...
d6.setNeighbor(d5, 4)
d6.setNeighbor(e6, 11)
d6.setNeighbor(c6, 2)
d6.setNeighbor(d7, 3)

d7.setNeighbor(d6, 3)
d7.setNeighbor(c7, 7)
d7.setNeighbor(e7, 14)
d7.setNeighbor(d8, 1)

d8.setNeighbor(d7, 1)
d8.setNeighbor(c8, 9)
d8.setNeighbor(e8, 11)
...
e1.setNeighbor(d1, 3)
e1.setNeighbor(f1, 1)
e1.setNeighbor(e2, 10)

e2.setNeighbor(e1, 10)
e2.setNeighbor(d2, 4)
e2.setNeighbor(f2, 1)
e2.setNeighbor(e3, 3)

e3.setNeighbor(e2, 3)
e3.setNeighbor(d3, 10)
e3.setNeighbor(f3, 8)
e3.setNeighbor(e4, 2)
...
e5.setNeighbor(e4, 8)
e5.setNeighbor(d5, 8)
e5.setNeighbor(f5, 10)
e5.setNeighbor(e6, 4)

e6.setNeighbor(e5, 4)
e6.setNeighbor(d6, 11)
e6.setNeighbor(f6, 10)
e6.setNeighbor(e7, 8)

e7.setNeighbor(e6, 8)
e7.setNeighbor(d7, 14)
e7.setNeighbor(f7, 2)
e7.setNeighbor(e8, 4)

e8.setNeighbor(e7, 4)
e8.setNeighbor(d8, 11)
e8.setNeighbor(f8, 10)
...
f4.setNeighbor(f3, 2)
f4.setNeighbor(g4, 10)
f4.setNeighbor(e4, 7)
f4.setNeighbor(f5, 3)

f5.setNeighbor(f4, 3)
f5.setNeighbor(e5, 10)
f5.setNeighbor(g5, 3)
f5.setNeighbor(f6, 12)

f6.setNeighbor(f5, 12)
f6.setNeighbor(g6, 10)
f6.setNeighbor(e6, 8)
f6.setNeighbor(f7, 2)
...
g1.setNeighbor(f1, 6)
g1.setNeighbor(h1, 2)
g1.setNeighbor(g2, 10)

g2.setNeighbor(g1, 10)
g2.setNeighbor(f2, 7)
g2.setNeighbor(h2, 8)
g2.setNeighbor(g3, 12)

g3.setNeighbor(g2, 12)
g3.setNeighbor(f3, 4)
g3.setNeighbor(h3, 2)
g3.setNeighbor(g4, 15)

g4.setNeighbor(g3, 15)
g4.setNeighbor(f4, 10)
g4.setNeighbor(g5, 4)
g4.setNeighbor(h4, 5)

g5.setNeighbor(g5, 4)
g5.setNeighbor(f5, 3)
g5.setNeighbor(h5, 12)
g5.setNeighbor(g6, 15)

g6.setNeighbor(g5, 15)
g6.setNeighbor(f6, 10)
g6.setNeighbor(h6, 2)
g6.setNeighbor(g7, 14)

g7.setNeighbor(g6, 14)
g7.setNeighbor(f7, 9)
g7.setNeighbor(h7, 1)
g7.setNeighbor(g8, 4)
...
h3.setNeighbor(h2, 4)
h3.setNeighbor(g3, 2)
h3.setNeighbor(i3, 10)
h3.setNeighbor(h4, 8)

h4.setNeighbor(h3, 8)
h4.setNeighbor(i4, 9)
h4.setNeighbor(g4, 5)
h4.setNeighbor(h5, 12)

h5.setNeighbor(h4, 12)
h5.setNeighbor(g5, 12)
h5.setNeighbor(i5, 2)
h5.setNeighbor(h6, 7)

h6.setNeighbor(h5, 7)
h6.setNeighbor(g6, 2)
h6.setNeighbor(i6, 10)
h6.setNeighbor(h7, 4)
...
i1.setNeighbor(i0, 9)
i1.setNeighbor(h1, 10)
i1.setNeighbor(j1, 10)
i1.setNeighbor(i2, 2)
...
i3.setNeighbor(i2, 7)
i3.setNeighbor(h3, 10)
i3.setNeighbor(j3, 8)
i3.setNeighbor(i4, 4)

i4.setNeighbor(i3, 4)
i4.setNeighbor(j4, 10)
i4.setNeighbor(h4, 9)
i4.setNeighbor(i5, 6)

i5.setNeighbor(i4, 6)
i5.setNeighbor(h5, 2)
i5.setNeighbor(j5, 13)
i5.setNeighbor(i6, 4)

i6.setNeighbor(i5, 4)
i6.setNeighbor(h6, 10)
i6.setNeighbor(j6, 3)
i6.setNeighbor(i7, 7)
...
j1.setNeighbor(j0, 7)
j1.setNeighbor(i1, 10)
j1.setNeighbor(k1, 14)
j1.setNeighbor(j2, 4)

j2.setNeighbor(j1, 4)
j2.setNeighbor(i2, 9)
j2.setNeighbor(k2, 11)
j2.setNeighbor(j3, 2)
...
j4.setNeighbor(j3, 3)
j4.setNeighbor(i4, 10)
j4.setNeighbor(k4, 9)
j4.setNeighbor(j5, 7)

j5.setNeighbor(j4, 7)
j5.setNeighbor(i5, 13)
j5.setNeighbor(k5, 8)
j5.setNeighbor(j6, 4)

j6.setNeighbor(j5, 5)
j6.setNeighbor(i6, 3)
j6.setNeighbor(k6, 18)
j6.setNeighbor(j7, 5)
...
k1.setNeighbor(k0, 4)
k1.setNeighbor(j1, 14)
k1.setNeighbor(l1, 8)
k1.setNeighbor(k2, 5)

k2.setNeighbor(k1, 5)
k2.setNeighbor(j2, 11)
k2.setNeighbor(l2, 9)
k2.setNeighbor(k3, 1)
...
k3.setNeighbor(j3, 4)
k3.setNeighbor(l3, 8)
k3.setNeighbor(k4, 11)

k4.setNeighbor(k3, 11)
k4.setNeighbor(j4, 9)
k4.setNeighbor(l4, 9)
k4.setNeighbor(k5, 7)
...
k5.setNeighbor(k4, 7)
k5.setNeighbor(j5, 8)
k5.setNeighbor(l5, 11)
k5.setNeighbor(k6, 16)

k6.setNeighbor(k5, 16)
k6.setNeighbor(j6, 18)
k6.setNeighbor(l6, 8)
k6.setNeighbor(k7, 6)
